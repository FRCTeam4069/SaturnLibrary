...
class DifferentialDrive(
    ...
    fun solveInverseKinematics(chassisMotion: ChassisState): WheelState {
        ...
        wheelMotion.left = (2 * chassisMotion.linear - effectiveWheelBaseRadius * chassisMotion.angular) / 2.0
        wheelMotion.right = (2 * chassisMotion.linear + effectiveWheelBaseRadius * chassisMotion.angular) / 2.0
        return wheelMotion
    }
    ...
    // Pose2dCurvature is redundant here in the case that chassisVelocity is not purely angular.  It is the responsibility of
