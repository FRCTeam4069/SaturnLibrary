 ...
 */
class StateSpaceObserver<States: `100`, Inputs: `100`, Outputs: `100`>(coeffs: StateSpaceObserverCoeffs<States, Outputs>, val plant: StateSpacePlant<States, Inputs, Outputs>) {
